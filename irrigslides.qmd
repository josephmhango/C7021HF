...
> Irrigation aims to replace the deficit — not exceed it.

:::

::: {.column width="45%"}
![](waterbalance.png){width="85%"}
:::
:::
...
flowchart LR
    ...
    subgraph Auto ["Data...."]
        direction TB
        D[("🛰️ Satellite")]:::autoStyle
        E[("🌍 Soil Data")]:::autoStyle
        F[("🌦️ Weather")]:::autoStyle
    end
